                            ...
                            <div>
                                <a href="/" class="d-inline-block auth-logo">
                                    @if(\App\Models\Setting::getSetting('logo'))
                                        <img src="{{ asset(\App\Models\Setting::getSetting('logo')) }}" alt="" height="20">
                                    @elseif(!\App\Models\Setting::getSetting('logo_text'))
                                        <img src="{{ asset('assets/images/logo-light.png') }}" alt="" height="20">
                                    @endif
                                </a>
                            </div>
                            <h3 class="mt-3 text-white fw-bold">{{ \App\Models\Setting::getSetting('logo_text') ?: 'POS Software' }}</h3>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> {{ \App\Models\Setting::getSetting('logo_text') ?: 'POS Software' }}.
                            </p>
                        </div>
                    </div>
                </div>
