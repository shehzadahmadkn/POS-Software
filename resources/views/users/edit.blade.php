                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Password: <small class="text-muted">(Leave blank if you don't want to change)</small></label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="location_id" class="form-control">
                                    ...
                                    @foreach($locations as $id => $name)
                                        <option value="{{ $id }}" {{ $user->location_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
