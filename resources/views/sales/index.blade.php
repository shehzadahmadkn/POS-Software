<x-app-layout>
            ...
            <div class="col-12">
                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-16 mb-1">Sales Management</h4>
                    </div>
                    <div class="mt-3 mt-lg-0">
                        <a href="{{ route('sales.create') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> POS / New Sale</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="salesTable" class="table table-bordered dt-responsive nowrap align-middle" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Inv#</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('click', '.edit-sale-btn, .view-sale-btn', function(e) {
                e.preventDefault();
