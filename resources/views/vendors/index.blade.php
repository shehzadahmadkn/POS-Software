<x-app-layout>
            ...
            <div class="card" id="vendorList">
                <div class="card-header border-0 pb-0">
                    <div class="row align-items-center">
                        <div class="col-sm">
                            <h5 class="card-title mb-0">Vendor Accounts</h5>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="vendorTable" class="table table-bordered dt-responsive nowrap align-middle" style="width:100%">
                            ...
                            <tbody>
                                @foreach($vendors as $index => $vendor)
                                    <tr>
                                        ...
                                        <td class="fw-bold {{ $vendor->balance < 0 ? 'text-danger' : 'text-success' }}">
                                            {{ $vendor->balance < 0 ? '-' : '' }}{{ number_format(abs($vendor->balance), 2) }}
                                        </td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0);" onclick="openStatementModal('vendor', {{ $vendor->id }}, '{{ addslashes($vendor->name) }}')">
                                                            <i class="ri-file-list-3-line align-bottom me-2 text-muted"></i> View Statement
                                                        </a>
                                                    </li>
                                                    @can('edit-vendor')
                                                    <li>
                                                        <a class="dropdown-item edit-item-btn" href="javascript:void(0);" onclick="openEditModal({{ $vendor->id }}, '{{ addslashes($vendor->name) }}', '{{ addslashes($vendor->phone) }}', '{{ addslashes($vendor->address) }}')">
    ...
    <script>
        ...
        function openEditModal(id, name, phone, address) {
            document.getElementById('editForm').action = `/vendors/${id}`;
